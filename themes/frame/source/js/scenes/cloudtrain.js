// Cloud Train Scene — 云间列车
// Shadertoy-style dual-pass scene: buffer (with temporal blend) + image (vignette)
//
// iChannel0 = noise texture (1024x1024, repeat)
// iChannel1 = previous frame (ping-pong FBO)

window.ShaderScene = {

  noiseTexture: (document.getElementById('cloudtrain-canvas') || {}).getAttribute
    ? document.getElementById('cloudtrain-canvas').getAttribute('data-noise-src')
    : null,
  ...
  bufferShader: [
    ...
    '',
    '// ============ Foreground layers (closest to camera) ============',
    '',
    ...
    '}',
    '',
    '// ============ Background layers (far mountains & sky) ============',
    '',
